...
public class RexxarDateUtils {  
    ...
    /**
     * 求date1和date2之间隔了几天，  date1-date2
     * @param date1
     * @param date2
     * @return
     * @throws ParseException
     */
    public static long subTwoDays(String date1, String date2) throws ParseException{
    	Date d1 = DateUtils.parseDate(date1, DATE_FORMAT);
        Date d2 = DateUtils.parseDate(date2, DATE_FORMAT);  
...
//        System.out.println(getWeekDay(Calendar.getInstance()));  
          System.out.println(subTwoDays("2016-06-27","2016-05-06"));  
